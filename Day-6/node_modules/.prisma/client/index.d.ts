...
export namespace Prisma {
  ...
  */
  ...
  export type restaurantsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"restaurants_id" | "restaurant_name" | "imageurl" | "location" | "offer", ExtArgs["result"]["restaurants"]>
  ...
  export interface restaurantsDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * 
     * // Only select the `restaurants_id`
     * const restaurantsWithRestaurants_idOnly = await prisma.restaurants.findMany({ select: { restaurants_id: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Restaurants and only return the `restaurants_id`
     * const restaurantsWithRestaurants_idOnly = await prisma.restaurants.createManyAndReturn({
     *   select: { restaurants_id: true },
     *   data: [
     *     // ... provide data here
     *   ]
     * })
     ...
     * })
     * 
     * // Update zero or more Restaurants and only return the `restaurants_id`
     * const restaurantsWithRestaurants_idOnly = await prisma.restaurants.updateManyAndReturn({
     *   select: { restaurants_id: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface restaurantsFieldRefs {
    readonly restaurants_id: FieldRef<"restaurants", 'String'>
    readonly restaurant_name: FieldRef<"restaurants", 'String'>
    readonly imageurl: FieldRef<"restaurants", 'String'>
    readonly location: FieldRef<"restaurants", 'String'>
    readonly offer: FieldRef<"restaurants", 'Int'>
  }
  ...
  export type restaurantsWhereInput = {
    ...
    restaurants_id?: StringFilter<"restaurants"> | string
    restaurant_name?: StringFilter<"restaurants"> | string
    imageurl?: StringFilter<"restaurants"> | string
    location?: StringFilter<"restaurants"> | string
    offer?: IntFilter<"restaurants"> | number
  }

  export type restaurantsOrderByWithRelationInput = {
    restaurants_id?: SortOrder
  ...
  export type restaurantsWhereUniqueInput = Prisma.AtLeast<{
    ...
    location?: StringFilter<"restaurants"> | string
    offer?: IntFilter<"restaurants"> | number
  }, "restaurants_id" | "restaurant_name">
  ...
  export type restaurantsScalarWhereWithAggregatesInput = {
    ...
    restaurants_id?: StringWithAggregatesFilter<"restaurants"> | string
    restaurant_name?: StringWithAggregatesFilter<"restaurants"> | string
    imageurl?: StringWithAggregatesFilter<"restaurants"> | string
    location?: StringWithAggregatesFilter<"restaurants"> | string
    offer?: IntWithAggregatesFilter<"restaurants"> | number
  }
  ...
  export type restaurantsUpdateInput = {
    restaurants_id?: StringFieldUpdateOperationsInput | string
